...
class ${className}Controller {
    ...
    def list = {
        ...
        if (params.json) {
            String json = new JSONCoder(${propertyName}List) as String
            String paramsJson = new JSONCoder(params) as String
            render "{list:\${json},count:\${${propertyName}Count},params:\${paramsJson}}"
        } else {
